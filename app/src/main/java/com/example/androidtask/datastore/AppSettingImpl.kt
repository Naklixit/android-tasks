...
class AppSettingImpl(private val context: Context) : AppSetting {
    ...
    override suspend fun setNotification(isNotificationOn: Boolean) = withContext(Dispatchers.IO) {
    ...
    override suspend fun getNotificationOn(): Boolean = withContext(Dispatchers.IO) {
